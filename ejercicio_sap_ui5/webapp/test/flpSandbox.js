		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ejercicio Sap UI5",
									"targetURL": "#comproyejerciciosapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comproyejerciciosapui5-display": {
								"semanticObject": "comproyejerciciosapui5",
								"action": "display",
								"description": "A Ejercicio Sap UI5 application.",
								"title": "Ejercicio Sap UI5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.proy.ejerciciosapui5",
									"url": sap.ui.require.toUrl("com/proy/ejerciciosapui5")
								}
							}
						}
					}
